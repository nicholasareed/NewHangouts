<?php 
$themes = array('Bootstrap', 'Amelia', 'Cerulean', 'Cosmo', 'Cyborg', 'Flatly', 'Journal', 'Readable', 'Simplex', 'Slate', 'Spacelab', 'Spruce', 'Superhero', 'United');
...
if (signed_in() == true) {
	...
	$user_data 		= user_data($session_user_id, 'user_id', 'username', 'password', 'first_name', 'last_name', 'email', 'type', 'theme', 'timestamp', 'allow_email', 'profile', 'active', 'bio');
